...
import loader
from waveganNET import WaveGANGenerator, WaveGANDiscriminator, WaveGANQ
...
def train(fps, args):
  ...
  uniform = tf.random_uniform([args.train_batch_size,args.wavegan_latent_dim-args.num_categ],-1.,1.)
